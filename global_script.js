...
const rules = [
  ...
  'PROCESS-NAME,UURemote.exe,DIRECT',
...
const chinaDNS = ['dhcp://en0','119.29.29.29', '223.5.5.5']
...
function main(config) {
  ...
  if (ruleOptions.openai) {
    ...
    ruleProviders.set('ai', {
      ...
      behavior: 'classical',
      format: 'text',
      url: 'https://testingcf.jsdelivr.net/gh/dahaha-365/YaNet@dist/rulesets/mihomo/ai.list',
  ...
  if (ruleOptions.tracker) {
    ...
    rules.push('DOMAIN-SUFFIX,proxima.nie.netease.com,REJECT')
    rules.push('DOMAIN-SUFFIX,proxima.nie.easebar.com,REJECT')
    config['proxy-groups'].push({
      ...groupBaseOption,
      name: '跟踪分析',
      type: 'select',
  ...
  if (ruleOptions.japan) {
    ...
    ruleProviders.set('category-bank-jp', {
      ...
      behavior: 'domain',
      format: 'mrs',
      url: 'https://testingcf.jsdelivr.net/gh/MetaCubeX/meta-rules-dat@meta/geo/geosite/category-bank-jp.mrs',
    ...
    config['proxy-groups'].push({
      ...
      icon: 'https://testingcf.jsdelivr.net/gh/Koolson/Qure/IconSet/Color/JP.png',
    })
  }
